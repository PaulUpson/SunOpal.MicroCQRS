...
namespace Massive
{
  ...
  public class DynamicModel : DynamicObject
  {
    ...
    public IEnumerable<dynamic> Fetch(string sql, params object[] args)
    {
    ...
    {
      // made public to work with event store
    ...
    //validation methods
    public virtual void ValidatesPresenceOf(object value, string propertyName = "", string message = "Required")
    {
      if (value == null)
    ...
    //fun methods
    public virtual void ValidatesNumericalityOf(object value, string propertyName = "", string message = "Should be a number")
    {
    ...
    public virtual void ValidateIsCurrency(object value, string propertyName = "", string message = "Should be money")
    {
      if (value == null) {
        Errors.Add(propertyName, message);
        return;
